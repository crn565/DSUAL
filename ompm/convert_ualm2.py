...
def convert_ualm2(ualm_path, output_filename, START_DATETIME, END_DATETIME,format="HDF"):
    """
    Parameters
    ----------
    ualm_path : str
    ...
    metadata_dir = join(get_module_directory(), 'dataset_converters', 'ualm2', 'metadata')
